...
interface ManualAddAccountFormProps {
  onSaved: () => void;
}

export function ManualAddAccountForm({ onSaved }: ManualAddAccountFormProps) {
  ...
  }, [addAccount, digits, isSubmitDisabled, onSaved, period, validation]);
